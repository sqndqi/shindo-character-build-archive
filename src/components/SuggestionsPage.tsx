...
export default function SuggestionsPage() {
  ...
  return <main className="suggestions-page">
    <header className="systems-hero"><span className="eyebrow"><MessageSquareText size={15} /> SUGGESTIONS</span><h1>Suggest a character or build.</h1><p>Suggestions are reviewed before becoming official builds. Nothing is uploaded from this form.</p></header>
